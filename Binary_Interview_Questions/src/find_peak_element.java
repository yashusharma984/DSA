// find the peak element ... arr =[1,2,3,4,5,3,1]
// target =3;
public class find_peak_element {
    public static void main(String[] args) {
     int[] num = {1,2,3,1,5,3,1};
     int target =3;
     int ans = peakIndexMountainArray(num , target);
        System.out.println("peak element of mountain : "+ ans);
    }
    public static int peakIndexMountainArray(int[]arr , int target){
        int start =0 ;
